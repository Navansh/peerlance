...
async function sendTokenClicked() {
  // alert(userAccountId.value)
}
    ...
    <div grid grid-cols-3 gap-4>
      <div v-for="project in projects" :key="project.projectId" flex flex-col gap-2 border-2 rounded-xl>
        ...
        <div w-full flex gap-4 px-4 pb-2>
          ...
          <button class="bg-[#424448]" w-full flex items-center justify-center gap-2 rounded-md py-1 @click="sendTokenClicked">
            <div>
